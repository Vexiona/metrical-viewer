...
zip: build/viewer.html
	zip -9 build/anthologia-palatina.zip build/viewer.html data/*.csv data/*.xlsx src/*.py src/*.html src/*.css src/*.js Makefile LICENSE LICENSE-CODE LICENSE-DATA README.md
